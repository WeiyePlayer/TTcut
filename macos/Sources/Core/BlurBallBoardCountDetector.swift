...
/// Board-count event detector ported from the Windows worker's
/// `worker/ttcut_worker/blurball_bounce.py` implementation.
public enum BlurBallBoardCountDetector {
  struct Candidate {
