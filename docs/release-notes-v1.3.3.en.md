# TTcut Windows v1.3.3

[简体中文](https://github.com/WeiyePlayer/TTcut/blob/v1.3.3/docs/release-notes-v1.3.3.md) | **English**

`v1.3.3` is a stable TTcut update for Windows x64. It adds merged rally exports across multiple videos, upgrades the default rally-recognition strategy, and fixes confirmed issues.
...
## Rally-recognition improvements

- The default recognizer now combines motion trajectories with bounce evidence. Continuous-motion and bounce-event modes remain available.
