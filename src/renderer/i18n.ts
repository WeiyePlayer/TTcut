...
const zh = {
  ...
  timeline: '自定义剪辑时间轴', togglePlayback: '播放或暂停监视窗口', zoomOut: '缩小时间轴', zoomIn: '放大时间轴', resizeStart: '调整片段开始', resizeEnd: '调整片段结束',
...
const en: Messages = {
  ...
  timeline: 'Custom cut timeline', togglePlayback: 'Play or pause monitor', zoomOut: 'Zoom timeline out', zoomIn: 'Zoom timeline in', resizeStart: 'Resize clip start', resizeEnd: 'Resize clip end',
