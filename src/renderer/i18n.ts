...
const zh = {
  ...
  refreshComponents: '重新检测', setupWorking: '正在设置本地组件', setupSuccess: '组件安装和自检已完成。', setupCancelled: '组件设置已取消，可稍后继续。', setupFailed: '组件设置失败。请重试或查看日志。', setupNetworkFailed: '网络连接多次中断。已保留下载部分；检查网络或代理后重试将从断点继续。',
...
const en: Messages = {
  ...
  refreshComponents: 'Check again', setupWorking: 'Setting up local components', setupSuccess: 'Installation and component self-test completed.', setupCancelled: 'Component setup was canceled. You can continue later.', setupFailed: 'Component setup failed. Retry or open the logs.', setupNetworkFailed: 'The network connection was interrupted repeatedly. Downloaded data was kept; check the network or proxy and retry to resume.',
