const targets = [
  { name: 'numpy', version: '2.5.1', source: 'pypi', file: /^numpy-2\.5\.1-cp312-cp312-win_amd64\.whl$/, variants: ['cpu', 'cu126', 'cu132'] },
  { name: 'opencv-python', version: '4.13.0.92', source: 'pypi', file: /^opencv_python-4\.13\.0\.92-cp37-abi3-win_amd64\.whl$/, variants: ['cpu', 'cu126', 'cu132'] },
  { name: 'filelock', version: '3.30.3', source: 'pypi', file: /^filelock-3\.30\.3-py3-none-any\.whl$/, variants: ['cpu', 'cu126', 'cu132'] },
  { name: 'fsspec', version: '2026.6.0', source: 'pypi', file: /^fsspec-2026\.6\.0-py3-none-any\.whl$/, variants: ['cpu', 'cu126', 'cu132'] },
  { name: 'Jinja2', version: '3.1.6', source: 'pypi', file: /^jinja2-3\.1\.6-py3-none-any\.whl$/, variants: ['cpu', 'cu126', 'cu132'] },
  { name: 'MarkupSafe', version: '3.0.3', source: 'pypi', file: /^markupsafe-3\.0\.3-cp312-cp312-win_amd64\.whl$/, variants: ['cpu', 'cu126', 'cu132'] },
  { name: 'mpmath', version: '1.3.0', source: 'pypi', file: /^mpmath-1\.3\.0-py3-none-any\.whl$/, variants: ['cpu', 'cu126', 'cu132'] },
  { name: 'networkx', version: '3.6.1', source: 'pypi', file: /^networkx-3\.6\.1-py3-none-any\.whl$/, variants: ['cpu', 'cu126', 'cu132'] },
  { name: 'setuptools', version: '81.0.0', source: 'pypi', file: /^setuptools-81\.0\.0-py3-none-any\.whl$/, variants: ['cpu', 'cu126', 'cu132'] },
  { name: 'sympy', version: '1.14.0', source: 'pypi', file: /^sympy-1\.14\.0-py3-none-any\.whl$/, variants: ['cpu', 'cu126', 'cu132'] },
  { name: 'typing-extensions', version: '4.16.0', source: 'pypi', file: /^typing_extensions-4\.16\.0-py3-none-any\.whl$/, variants: ['cpu', 'cu126', 'cu132'] },
  ...
  { name: 'torch', version: '2.12.1+cu132', source: 'https://download.pytorch.org/whl/cu132/torch/', file: /^torch-2\.12\.1\+cu132-cp312-cp312-win_amd64\.whl$/, variants: ['cu132'] },
];
