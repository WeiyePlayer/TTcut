...
try {
  ...
  const input={videoPath:media,calibrationChoice:{method:'manual',calibration},device:'auto',historyVisibility:'visible',analysisMode:'full',normalizeVariableFrameRate:false,blurballConfidenceThreshold:0.7,blurballStage1ConfidenceThreshold:0.3,blurballStage2ConfidenceThreshold:0.7};
