...
<body><h1>TTcut 第三方许可证</h1><p>本页列出桌面应用、随安装器分发的模型资源及受管下载组件的许可证材料。Python、PyTorch、NumPy、OpenCV 与 FFmpeg 仍按需安装，并在各自组件目录保留随包许可证。</p>
<table><thead><tr><th>组件</th><th>版本</th><th>声明的许可证</th><th>许可证材料</th></tr></thead><tbody>${rows}</tbody></table>
