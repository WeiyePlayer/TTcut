...
try {
  ...
  await check('explicit menu quit confirms cancellation and waits for cleanup',async()=>{
    await page.evaluate(async videoPath=>window.ttcut.startAnalysis({videoPath,calibrationChoice:{method:'manual',calibration:{video_width:320,video_height:180,points:{top_left:[60,40],top_right:[250,40],bottom_right:[275,145],bottom_left:[40,145]}}},device:'auto',historyVisibility:'visible',normalizeVariableFrameRate:false}),media[0]);
