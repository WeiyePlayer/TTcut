...
class BlurBall(nn.Module):
    ...
    def _make_deconv_layers(self, cfg, input_channels):
        deconv_cfg = cfg["MODEL"]["EXTRA"]["DECONV"]
...
def create_blurball():
    """Create the fixed 3-frame BlurBall architecture used by TTcut."""
    return BlurBall(BLURBALL_MODEL_CONFIG)
