const downloadUrl = "https://github.com/WeiyePlayer/TTcut/releases/download/v1.3.5/TTcut-1.3.5-x64-Setup.exe";
...
const faqs = [
  ...
  },
  {
    ...
    answer: "v1.3.5 使用 CN=weiye 自签名 Authenticode 并带时间戳，但证书不受 Windows 公共信任，因此仍可能触发未知发布者或 SmartScreen。请只从本项目 GitHub Release 下载并核对 SHA-256。",
  },
];
  ...
  return (
    <main>
      <header className="site-header">
        ...
        <a className="button button-small" href={downloadUrl} target="_blank" rel="noreferrer" aria-label="下载 TTcut v1.3.5 Windows x64 安装包">
          下载 <span className="desktop-only">v1.3.5</span><ArrowIcon />
        </a>
      </header>
      ...
      <section className="hero section-shell" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <a className="button button-primary" href={downloadUrl} target="_blank" rel="noreferrer" aria-label="下载 TTcut v1.3.5 Windows x64 安装包">
              下载 TTcut <ArrowIcon />
            </a>
      ...
      <section className="final-cta section-shell">
        <p className="eyebrow">TTcut v1.3.5 正式版</p>
        <h2>下一场好球，<br />从这里开始。</h2>
        <p>下载 Windows x64 版本，让比赛视频留在本地，让精彩回合更容易被看见。</p>
        <a className="button button-light" href={downloadUrl} target="_blank" rel="noreferrer" aria-label="下载 TTcut v1.3.5 Windows x64 安装包">下载 TTcut <ArrowIcon /></a>
      </section>

      <footer className="site-footer section-shell">
        <a className="brand" href="#top"><img src="/ttcut-icon.png" alt="" />TTcut</a>
        <p>本地离线乒乓球回合分析与自动剪辑工具。</p>
        <div><a href={repositoryUrl} target="_blank" rel="noreferrer">GitHub</a><a href={downloadUrl} target="_blank" rel="noreferrer" aria-label="下载 TTcut v1.3.5 Windows x64 安装包">下载</a><a href={`${repositoryUrl}/blob/main/LICENSE`} target="_blank" rel="noreferrer">MIT License</a></div>
      </footer>
    </main>
  );
}
