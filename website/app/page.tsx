const downloadUrl = "https://github.com/WeiyePlayer/TTcut/releases/download/v1.3.4/TTcut-1.3.4-x64-Setup.exe";
...
const features = [
  {
    number: "01",
    title: "自动标定与识别",
    description: "TTcut 默认融合运动轨迹与落点证据识别回合，也可切换为连续运动或落台判定。",
  },
  {
    number: "02",
    title: "三种剪辑模式",
    description: "保留全部回合、按时长档位或板数筛选精彩回合，或逐个选择需要的片段。",
  },
  {
    number: "03",
    title: "时间轴精细编辑",
    description: "自定义模式可切换原片或所选回合连续播放，并用滚轮缩放时间轴、调整每个片段的起止边界。",
  },
  {
    number: "04",
    title: "批量任务与恢复",
    description: "多个视频可按队列自动标定，并将所选回合合并为一个视频；任务切换页面后仍会保留。",
  },
  {
    number: "05",
    title: "保留完整上下文",
  ...
  },
  {
    number: "06",
    title: "安全导出",
    description: "可变帧率视频可按需重编码为固定帧率；成片保存到原视频目录，并会校验音画同步与可播放性。",
  },
];
...
const steps = [
  ...
  {
    label: "自动标定",
    copy: "TTcut 从多个时间点自动识别球桌并校验几何关系；识别失败或需要调整时，再进入手动四点标定。",
  },
  {
    label: "挑选回合",
...
const faqs = [
  ...
  },
  {
    ...
    answer: "v1.3.4 使用 CN=weiye 自签名 Authenticode 并带时间戳，但证书不受 Windows 公共信任，因此仍可能触发未知发布者或 SmartScreen。请只从本项目 GitHub Release 下载并核对 SHA-256。",
  },
];
  ...
  return (
    <main>
      <header className="site-header">
        ...
        <a className="button button-small" href={downloadUrl} target="_blank" rel="noreferrer" aria-label="下载 TTcut v1.3.4 Windows x64 安装包">
          下载 <span className="desktop-only">v1.3.4</span><ArrowIcon />
        </a>
      </header>
      ...
      <section className="hero section-shell" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <a className="button button-primary" href={downloadUrl} target="_blank" rel="noreferrer" aria-label="下载 TTcut v1.3.4 Windows x64 安装包">
              下载 TTcut <ArrowIcon />
            </a>
        ...
        <div className="section-shell">
          ...
          <div className="calibration-demo">
            <div className="calibration-copy">
              ...
              <p>需要手动恢复时，以任意顺序点击桌面四角。编号、连线与即时校验会帮助你确认位置；任何标记都能直接拖动修正。</p>
              <div className="point-order"><i>1</i><b>角点</b><i>2</i><b>角点</b><i>3</i><b>角点</b><i>4</i><b>角点</b></div>
            </div>
      ...
      <section className="section-shell content-section" id="modes">
        ...
        <div className="mode-grid">
          ...
          <article className="mode-card">
            ...
            <h3>精彩回合</h3><p>连续运动按时长档位筛选；切换为落台判定后，也可按 3、5 或 7 板筛选。</p>
            <div className="thresholds"><i>短</i><i className="active">中</i><i>长</i><span>时长档位</span></div>
          </article>
          <article className="mode-card">
      ...
      <section className="final-cta section-shell">
        <p className="eyebrow">TTcut v1.3.4 正式版</p>
        <h2>下一场好球，<br />从这里开始。</h2>
        <p>下载 Windows x64 版本，让比赛视频留在本地，让精彩回合更容易被看见。</p>
        <a className="button button-light" href={downloadUrl} target="_blank" rel="noreferrer" aria-label="下载 TTcut v1.3.4 Windows x64 安装包">下载 TTcut <ArrowIcon /></a>
      </section>

      <footer className="site-footer section-shell">
        <a className="brand" href="#top"><img src="/ttcut-icon.png" alt="" />TTcut</a>
        <p>本地离线乒乓球回合分析与自动剪辑工具。</p>
        <div><a href={repositoryUrl} target="_blank" rel="noreferrer">GitHub</a><a href={downloadUrl} target="_blank" rel="noreferrer" aria-label="下载 TTcut v1.3.4 Windows x64 安装包">下载</a><a href={`${repositoryUrl}/blob/main/LICENSE`} target="_blank" rel="noreferrer">MIT License</a></div>
      </footer>
    </main>
  );
}
