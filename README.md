...
> 当前稳定版本为 `v1.2.5`，面向 Windows x64；应用不再按 Windows build 或系统版本进行硬拦截。

## 下载与安装

1. 从 [TTcut v1.2.5 Release](https://github.com/WeiyePlayer/TTcut/releases/tag/v1.2.5) 下载 `TTcut-1.2.5-x64-Setup.exe`。
