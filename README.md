...
1. 从 [TTcut v1.1.1 Release](https://github.com/WeiyePlayer/TTcut/releases/tag/v1.1.1) 下载 `TTcut-1.1.1-x64-Setup.exe`。
...
详见 [v1.1.1 发布说明](docs/release-notes-v1.1.1.md)。
