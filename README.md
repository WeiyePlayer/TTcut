...
- 完善自定义剪辑页面和时间轴细节，新增、删除、预览和调整片段的操作更清晰稳定。
- 优化桌面端界面布局、控件状态与上传引导，提升小窗口和高 DPI 下的使用体验。
- 统一新视频的本地分析流程，并自动清理旧版本遗留的无效设置。
- 修复时间轴滚动边界、批量任务与若干界面交互问题。

详见 [v1.2.8 发布说明](docs/release-notes-v1.2.8.md)。
